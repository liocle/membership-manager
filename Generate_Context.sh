...
declare -A maps=(
    [app]="app/**/*.py app/Dockerfile app/entrypoint.sh app/requirements.txt app/pdf/templates/welcome_letter.html.jinja2"
    ...
    [Monitoring]="monitoring/**/*.yml monitoring/grafana/main.json"
